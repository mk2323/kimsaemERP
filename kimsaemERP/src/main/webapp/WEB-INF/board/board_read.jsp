...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#deletebtn").on("click",function(){
			location.href="/kimsaemERP/board/delete.do?board_no="
						+${board.board_no }
		});
	})
</script>
...
<body>
	...
	<form class="form-horizontal" 
		action="/kimsaemERP/board/read.do?state=UPDATE&board_no=${board.board_no }" 
		method="post" >
		...
		<div class="form-group">
			<div class="col-md-10 text-center">
				...
				<button type="button" class="btn btn-danger btn-lg"
					onclick="location.href='/kimsaemERP/board/list.do?category=all'">
					<i class="fa fa-fw fa-close"></i> 목록
				</button>
				<button type="button" class="btn btn-danger btn-lg"
					id="deletebtn" onclick="location.href='/board/delete.do?board_no=${board.board_no }'">
